...
Config.Garages = {
    ...
    spanishave = {
        label = 'Парковка на Испанской авеню',
    ...
    popsrigparking = {
        label = 'Парковка грузовиков Попа',
    ...
    ronsrigparking = {
        label = 'Парковка грузовиков Рона',
