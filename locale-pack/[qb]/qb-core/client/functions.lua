...
function QBCore.Functions.Notify(text, texttype, length, icon)
    ...
    -- Пока игрок в меню выбора/создания персонажа, все уведомления
    -- показываются справа сверху, чтобы не перекрывать карточки
    if LocalPlayer.state.buSelecting then
