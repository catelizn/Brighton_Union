QBCore.Shared.Items = {
    ...
    contraband = {name = "contraband", label = "Контрабанда", weight = 500, type = "item", image = "garbagebag.png", unique = false, useable = false, shouldClose = false, combinable = nil, description = "Товар для тёмных каналов"},
...
local itemOverrides = {
    ...
    sandwich = { label = 'Сэндвич', description = 'Отличный перекус на каждый день' },
    water_bottle = { label = 'Бутылка воды', description = 'Утоляет жажду' },
    coffee = { label = 'Кофе', description = 'Заряд кофеина' },
    kurkakola = { label = 'Кола', description = 'Утоляет жажду' },
    beer = { label = 'Пиво', description = 'Нет ничего лучше холодного пива!' },
    whiskey = { label = 'Виски', description = 'Крепкий напиток' },
    vodka = { label = 'Водка', description = 'Крепкий напиток' },
    ...
    joint = { label = 'Косяк', description = 'Самокрутка с травкой' },
    ...
    electronickit = { label = 'Набор электроники', description = 'Набор для начинающего инженера' },
    ...
    walkstick = { label = 'Трость', description = 'Трость для пожилых' },
