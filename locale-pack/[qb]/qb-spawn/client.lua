...
RegisterNetEvent('qb-spawn:client:setupSpawns', function(cData, new, apps)
    if not new then
        QBCore.Functions.TriggerCallback('qb-spawn:server:getOwnedHouses', function(houses)
            ...
            QBCore.Functions.TriggerCallback('bu-factions:server:getSpawns', function(factionSpawns)
                FactionSpawns = factionSpawns or {}
...
RegisterNUICallback('setCam', function(data, cb)
    ...
    elseif type == 'faction' then
        SetCam(FactionSpawns[tonumber(location) + 1].coords)
...
RegisterNUICallback('spawnplayer', function(data, cb)
    ...
    elseif type == 'normal' then
        ...
        PostSpawnPlayer()
    elseif type == 'faction' then
        local pos = FactionSpawns[tonumber(location) + 1].coords
        PreSpawnPlayer()
        SetEntityCoords(ped, pos.x, pos.y, pos.z)
        SetEntityHeading(ped, pos.w)
        TriggerServerEvent('QBCore:Server:OnPlayerLoaded')
