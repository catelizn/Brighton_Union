...
-- =====================================================================
-- Brighton Union: создание персонажа
-- =====================================================================

-- Камера на экране создания персонажа (та же раздевалка, что в предпросмотре)
Config.CreationCam = vector4(-763.1219, 326.8112, 200.0, 357.0954)

-- Имена родителей (наследственность как в GTA Online)
Config.FatherNames = {
    ...
    [20] = 'Anthony', [42] = 'Claude', [43] = 'Niko', [44] = 'John'
}

Config.MotherNames = {
    [21] = 'Hannah', [22] = 'Audrey', [23] = 'Jasmine', [24] = 'Giselle', [25] = 'Amelia',
    [26] = 'Isabella', [27] = 'Zoe', [28] = 'Ava', [29] = 'Camila', [30] = 'Violet',
    [31] = 'Sophia', [32] = 'Evelyn', [33] = 'Nicole', [34] = 'Ashley', [35] = 'Grace',
    [36] = 'Brianna', [37] = 'Natalie', [38] = 'Olivia', [39] = 'Elizabeth', [40] = 'Charlotte',
    [41] = 'Emma', [45] = 'Misty'
}

-- Три набора одежды на выбор при создании: игрок начинает с простой одеждой,
-- остальное покупает в магазине за игровые деньги.
-- Значения drawable взяты из рабочих комплектов ниже: они точно есть
-- в обеих моделях, поэтому части одежды не пропадают.
Config.CreationOutfits = {
    male = {
        {
            label = 'Повседневный',
            items = {
