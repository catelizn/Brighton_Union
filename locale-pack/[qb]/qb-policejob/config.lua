...
Config.Locations = {
    ...
    stations = {
        { label = 'Полицейский участок', coords = vector4(428.23, -984.28, 29.76, 3.5) },
        { label = 'Тюрьма',               coords = vector4(1845.903, 2585.873, 45.672, 272.249) },
        { label = 'Участок Палето',       coords = vector4(-451.55, 6014.25, 31.716, 223.81) },
    },
}
