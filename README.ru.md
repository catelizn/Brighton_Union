...
Скриншоты с плейтестов копятся для этого раздела — появятся, когда проект обрастёт записанными кадрами.

## Зачем это существует

Это полноценный RP-сервер. Каждая система валидируется на сервере, описана в собственном README и рассчитана на полный онлайн без деградации. Механики уровня Majestic RP, GTA5RP и NoPixel, написанные с нуля на открытой кодовой базе.
...
| [Планшет](resources/[brighton]/bu-tablet/README.md) | Планшет в стиле Apple с 9 приложениями | Документы, маркетплейс, новости, семья, фракция, такси, дальнобой, даркнет |
...
| [Аукционный дом](resources/[brighton]/bu-auction/README.md) | Живые аукционы на недвижимость, машины, предметы | Комиссия 10%, ставки ×1/×3/×5, антиснайп |
| [HUD](resources/[brighton]/bu-hud/README.md) | Собственный статус-HUD | Кружки статусов, деньги, локация, скрываемые подсказки |
...
| [Авторизация](resources/[brighton]/bu-auth/README.md) | Вход и регистрация до выбора персонажа | Пароли хэшируются (SHA-256), защита от перебора |
| [Территории банд](resources/[brighton]/bu-gangs/README.md) | Пресетные банды и 60 квадратов гетто | Захват только соседних, зоны видит своя банда, payday каждый час |
| [Войны мафий](resources/[brighton]/bu-mafias/README.md) | 4 мафии воюют за 7 бизнесов | Войны по рангу, payday каждый час |
| [Базы фракций](resources/[brighton]/bu-factions/README.md) | Базы с интерьерами, складами и квестами | Выбор спавна, гардероб у госструктур |
| [Магазин 24/7](resources/[brighton]/bu-shops-ui/README.md) | Витрина с категориями и поиском | Оплата наличными или картой, сток на сервере |
| [Оружие на теле](resources/[brighton]/bu-weaponback/README.md) | Оружие видно на персонаже | Винтовки за спиной, пистолеты в кобуре |
| [Коммуналка](resources/[brighton]/bu-bills/README.md) | Ежечасные счета за имущество | Платёж пропускается, если на счёте не хватает |
| [Подсказки GPS](resources/[brighton]/bu-gps/README.md) | Текстовые подсказки по пути к метке | Названия улиц на поворотах |
| [Пожарный](resources/[brighton]/bu-firefighter/README.md) | Случайные пожары по карте | Туши, оплата через движок работ |
| [Загрузочный экран](resources/[brighton]/bu-loading/README.md) | Фирменный экран загрузки с картинкой | Советы, переключение темы |
| [Интеракции](resources/[brighton]/bu-interact/README.md) | Общая библиотека маркеров, NPC и блипов | На ней работают все NPC и двери сервера |
